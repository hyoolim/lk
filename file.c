...
void lk_file_libinit(lk_vm_t *vm) {
    ...
    lk_object_setcfunc_lk(file, "close", close_file, NULL);
    lk_object_setcfunc_lk(file, "directory?", directoryQ_file, NULL);
    lk_object_setcfunc_lk(file, "delete", delete_file, NULL);
    lk_object_setcfunc_lk(file, "executable?", executableQ_file, NULL);
    lk_object_setcfunc_lk(file, "exists?", existsQ_file, NULL);
    lk_object_setcfunc_lk(file, "flush", flush_file, NULL);
    lk_object_setcfunc_lk(file, "init!", init_file_str, str, NULL);
    lk_object_setcfunc_lk(file, "move", move_file_str, str, NULL);
    lk_object_setcfunc_lk(file, "openForReading", openForReading_file, NULL);
    lk_object_setcfunc_lk(file, "openForWriting", openForWriting_file, NULL);
    lk_lib_setCField(file, "path", str, offsetof(lk_file_t, path));
    lk_object_setcfunc_lk(file, "read", read_file, NULL);
    lk_object_setcfunc_lk(file, "read", read_file_ch, ch, NULL);
    lk_object_setcfunc_lk(file, "read", read_file_charset, charset, NULL);
    lk_object_setcfunc_lk(file, "read", read_file_number, number, NULL);
    lk_object_setcfunc_lk(file, "readable?", readableQ_file, NULL);
    lk_object_setcfunc_lk(file, "size", size_file, NULL);
    lk_object_setcfunc_lk(file, "write", write_file_str, str, NULL);
    lk_object_setcfunc_lk(file, "writable?", writableQ_file, NULL);
    /* StandardInput */
