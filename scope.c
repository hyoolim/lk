...
void lk_scope_libinit(lk_vm_t *vm) {
    ...
    lk_object_set_cfunc_lk(scope, ".args", Dargs_scope, NULL);
    lk_object_set_cfunc_lk(scope, "=", DassignB_scope_str_obj, str, obj, NULL);
    ...
    lk_object_set_cfunc_lk(scope, "include", include_scope_str_str, str, str, NULL);
    lk_object_set_cfunc_lk(scope, "raise", raise_scope_err, err, NULL);
    lk_object_set_cfunc_lk(scope, "raise", raise_scope_str, str, NULL);
    lk_lib_setCField(scope, "receiver", obj, offsetof(lk_scope_t, receiver));
    lk_object_set_cfunc_lk(scope, "redo", redo_scope, NULL);
    lk_object_set_cfunc_lk(scope, "require", require_scope_str_str, str, str, NULL);
    lk_object_set_cfunc_lk(scope, "rescue", rescue_scope_f, f, NULL);
    lk_object_set_cfunc_lk(scope, "RESOURCE", RESOURCE_scope, NULL);
    lk_object_set_cfunc_lk(scope, "retry", retry_scope, NULL);
    lk_object_set_cfunc_lk(scope, "return", return_scope, -1);
}
