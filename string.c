...
void lk_string_libinit(lk_vm_t *vm) {
    ...
    lk_object_set_cfunc_lk(str, "at", at_str_number, number, NULL);
    lk_object_set_cfunc_lk(str, "find", find_str_ch_number, ch, number, NULL);
    lk_object_set_cfunc_lk(str, "find", find_str_charset_number, charset, number, NULL);
    lk_object_set_cfunc_lk(str, "find", find_str_str_number, str, number, NULL);
    lk_object_set_cfunc_lk(str, "set!", setB_str_number_ch, number, ch, NULL);
    lk_object_set_cfunc_lk(str, "set!", setB_str_number_number_str, number, number, str, NULL);
    lk_object_set_cfunc_lk(str, "toCharacterSet", to_character_qphash_str, NULL);
    lk_object_set_cfunc_lk(str, "toNumber", to_number_str, NULL);
}
